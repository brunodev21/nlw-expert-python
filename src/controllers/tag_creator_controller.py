...
from src.drivers.barcode_handler import BarcoderHandler
...
class TagCreatorController:
    ...
    def create(self, product_code: str) -> Dict:
        path_from_tag = self.___create_tag(product_code)
        formatted_response = self.__format_response(path_from_tag)
        return formatted_response

    def ___create_tag(self, product_code: str) -> str:
        barcode_handler = BarcoderHandler()
